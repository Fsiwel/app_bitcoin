...
var  response = await  http.get(Uri.parse('https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=brl'));
    ...
    return Scaffold(
      body:Container(
        ...
        children: [
          ...
          Text("R\$ " + preco.toString(), style: TextStyle(fontSize: 35),),
